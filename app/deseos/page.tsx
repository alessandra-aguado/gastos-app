  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      <div className="space-y-2.5 mb-6">
        <div className="bg-surface border border-border rounded-2xl px-4 py-3 flex justify-between items-center">
      ...
      <div className="bg-surface border border-border rounded-2xl p-4">
        ...
        <div className="flex gap-2 mb-3">
          ...
          <div className="bg-accent-soft rounded-2xl px-3 py-2.5 text-xs text-accent leading-relaxed">
